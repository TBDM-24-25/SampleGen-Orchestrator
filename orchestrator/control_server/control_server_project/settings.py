"""
Django settings for control_server_project project.
...
SECRET_KEY = 'django-insecure-#k^6*4_b-a$$3p&bx=%zher1birs_o$igjd+7gxrol81vice0$'
...
ROOT_URLCONF = 'control_server_project.urls'
...
WSGI_APPLICATION = 'control_server_project.wsgi.application'
